...
public class Ventana extends javax.swing.JFrame {
    ...
    private void conectaBaseDeDatos(){
        ...
        EntityManager entityManager = Persistence.createEntityManagerFactory("EjemploJaviPU").createEntityManager();
        ...
        for (Student student : students) {
            System.out.println(student.getSurnames() + "," + student.getName() + "(" + student.getClassGroup().getName() + ")");
        }
